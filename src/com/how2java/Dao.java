...
public class Dao {
    ...
    public Connection getConnection() throws SQLException{
        return DriverManager.getConnection("jdbc:mysql://192.168.0.209:3306/shiro?characterEncodinf=UTF-8","root","1234");
    }
    ...
    public Set<String> listRoles(String userName) {
        ...
        String sql = "select r.name from user u  left join user_role ur on u.id = ur.uid left join Role r on r.id = ur.rid "
                    + "where u.name = ?";
        try (
            Connection c = getConnection();
            PreparedStatement ps = c.prepareStatement(sql);) {
...
//        new Dao().createUser("wang5","123");
        User wang5 = new Dao().getUser("wang5");
        System.out.println(wang5.getPassword());
